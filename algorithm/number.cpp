...
#include <string.h>
/*********************************************************
 * Description: get prime in range(1 ~ n)                *
 * Parameters: n, primes: array adress                   *
 * Return: 1. return prime number, 2. fill primes        *
 * Note: n can't be bigger than 10^8                     *
 * *******************************************************/

int getPrimes(int n, int primes[])
{
	if (n > 10e8)
	{
		perror("n is too large\n");
		return;
	}
	int flag[n + 1];
